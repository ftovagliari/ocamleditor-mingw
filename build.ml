...
let external_tasks = [
  ...
  5, (fun command -> {
    ...
    et_dir                   = "";
    et_cmd                   = "ocaml";
    et_args                  = [true,"../tools/editbin.ml"; true,"ocamleditorw.exe"];
